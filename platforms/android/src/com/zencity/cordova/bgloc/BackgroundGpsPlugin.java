...
public class BackgroundGpsPlugin extends CordovaPlugin {
    ...
    public static final String DELETE_ALL_LOCATIONS = "delete_all_locations";
    ...
    private String persistLocation = "false";
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) {
        ...
        if (ACTION_START.equalsIgnoreCase(action) && !isEnabled) {
            ...
            if (params == null || headers == null || url == null) {
                ...
                updateServiceIntent.putExtra("persistLocation", persistLocation);
            ...
            callbackContext.success();
       } else if (DELETE_ALL_LOCATIONS.equalsIgnoreCase(action)) {
                result = true;
                activity.stopService(updateServiceIntent);
                callbackContext.success();
            ...
            try {
                ...
                //[params, headers, url, stationaryRadius, distanceFilter, locationTimeout, desiredAccuracy, debug, notificationTitle, notificationText, activityType, stopOnTerminate, persistLocation]
                ...
                this.persistLocation = data.getString(12);
